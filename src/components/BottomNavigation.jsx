...
export const BottomNavigation = () => {
  return (
        ...
        <header className="fixed bottom-0 gap-4 z-10 w-[100%] h-[10px] bg-sky-300 p-8 rounded-t-xl  transition-all duration-500  group hover:h-[100px] md:relative md:flex md:justify-start md:items-center md:rounded-t-none md:rounded-b-xl">
